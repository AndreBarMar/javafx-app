...
import com.andrebarbosa.javafxapp.models.AreaRestrita;
...
public class EquipamentosController extends BaseController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        for (AreaRestrita ar : empresa.getRegistoAreasRestritas()) {
            listaAreasRestritas.add(ar.getId() + ": Localização: " + ar.getLocalizacao() + " | Descrição: "
                    + ar.getDescricao() + " | Lotação Máxima: " + ar.getLotacaoMaxima());
        }
    ...
    protected void handleAddEquipamento(ActionEvent event) {
        ...
        try {
            ...
            Utils.openAlert(Utils.INFORMATION, "Equipamento adicionado com sucesso.", null,
