...
import com.andrebarbosa.javafxapp.models.Equipamento;
import com.andrebarbosa.javafxapp.models.PeriodoAutorizacao;
...
public class PeriodosAutorizacaoController extends BaseController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        for (Equipamento e : empresa.getRegistoEquipamentos()) {
            listaEquipamentos.add(e.getId() + ": Descrição: " + e.getDescricao() + " | Movimento: "
                    + e.getTipoMovimento() + " | Área Restrita: " + e.getAreaRestritaAssociada());
        }
    ...
    protected void handleAddPeriodoAutorizacao(ActionEvent event) {
        ...
        try {
            ...
            Utils.openAlert(Utils.INFORMATION, "Período de Autorização adicionado com sucesso.", null,
    ...
    protected void handleDeletePeriodoAutorizacao(ActionEvent event) {
        ...
        try {
            ...
            Utils.openAlert(Utils.INFORMATION, "Período de Autorização eliminado com sucesso.", null,
                    Alert.AlertType.INFORMATION);
        } catch (Exception e) {
            Utils.openAlert(Utils.ERROR, e.getLocalizedMessage(), null, Alert.AlertType.ERROR);
        }
